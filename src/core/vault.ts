...
export function generateVaultArtifacts(root?: string): VaultArtifacts {
  ...
  fs.writeFileSync(claudePath, agentGuide, "utf8");
...
function renderAgentGuideMarkdown(): string {
  return [
    "# Trove Vault Agent Guide",
    "",
    "This file is generated by `trove index` and written to both `AGENTS.md` and `CLAUDE.md` for agent compatibility.",
    "",
    "This directory is a local-first archive of saved items, likes, stars, favorites, and chat exports collected by Trove.",
    "",
    "## Start here",
    "",
    "1. Read `INDEX.md` first for source counts, recent items, and top authors.",
    "2. Use `trove search \"<query>\"` when the CLI is available.",
