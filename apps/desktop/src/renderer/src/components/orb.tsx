...
// Soft warm gray — subtle ring on light background
const vec3 baseColor1 = vec3(0.82, 0.81, 0.80);
const vec3 baseColor2 = vec3(0.70, 0.69, 0.68);
const vec3 baseColor3 = vec3(0.45, 0.44, 0.43);
